...
-- Phase 5 rollback. This restores the Phase 4 schema boundary without deleting
-- historical audit rows that may have been generated while Phase 5 was active.
