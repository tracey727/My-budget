...
-- Phase 6 / 012 — isolated-test correction before production promotion.
-- audit_events.id is bigint; the export audit helper must return the same type.
...
VALUES ('012', 'Phase 6 export audit identifier type correction')
